...
from vlog_tool.ai.token_usage import _EMPTY_STATS, FileTokenUsageStore, _merge_stats
...
class TestFileTokenUsageStore:
    ...
    def test_record_creates_file(self, tmp_path):
        ...
        with patch("vlog_tool.ai.token_usage.write_json_atomic") as mock_write:
    ...
    def test_get_stats_after_multiple_records(self, tmp_path):
        ...
        with patch("vlog_tool.ai.token_usage.write_json_atomic"):
            store.record("video_analyze", "gemini-2.5-flash", usage)

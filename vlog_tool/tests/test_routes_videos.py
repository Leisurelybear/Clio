"""Tests for vlog_tool/ui/routes/videos.py — _parse_segment_info + handler mocks."""
...
from vlog_tool.ui.routes.videos import _parse_segment_info, handle_get_video, handle_get_videos

...
class TestHandleGetTexts:
    def test_not_found(self, handler):
        ...
        from vlog_tool.ui.routes.texts import handle_get_texts
...
class TestHandleGetVoiceover:
    def test_not_found(self, handler):
        ...
        from vlog_tool.ui.routes.texts import handle_get_voiceover
...
class TestHandlePutTexts:
    def test_forbidden(self, handler):
        handler._resolve_texts.return_value = None
        from vlog_tool.ui.routes.texts import handle_put_texts
    ...
    @patch("vlog_tool.ui.routes.texts._save_atomic")
...
class TestHandlePutVoiceover:
    def test_forbidden(self, handler):
        handler._resolve_in.return_value = None
        from vlog_tool.ui.routes.texts import handle_put_voiceover

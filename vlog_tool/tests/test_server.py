"""Tests for vlog_tool/ui/server.py — HTTP server & Handler."""
...
from vlog_tool.ui.server import STATIC_DIR, _ServerState, make_handler
...
def handler_cls(mock_config):
    ...
    with patch("vlog_tool.ui.server.ConfigCache"):
...
class TestMakeHandler:
    ...
    def test_config_cache_on_load(self, mock_config):
        with patch("vlog_tool.ui.server.ConfigCache") as mock_cc:
...
class TestDelegation:
    ...
    @patch("vlog_tool.ui.server.resolve_project_input")
    ...
    @patch("vlog_tool.ui.server.resolve_project_input")
    @patch("vlog_tool.ui.server._project_output_dir")
...
class TestDoGET:
    @patch("vlog_tool.ui.server.handle_index")
    ...
    @patch("vlog_tool.ui.server.handle_get_config")
    ...
    @patch("vlog_tool.ui.server.handle_get_vmeta")
    ...
    @patch("vlog_tool.ui.server.read_session_log")
...
class TestDoPUT:
    ...
    @patch("vlog_tool.ui.server.handle_put_config_raw")
...
class TestDoPOST:
    ...
    @patch("vlog_tool.ui.server.clear_session_log")
